...
int main() {
    ...
    Shader ourShader("../src/shaders/2.vertex.shader", "../src/shaders/2.fragment.shader");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glDrawArrays(GL_TRIANGLES, 0, 6); // set the count to 6 since we're drawing 6 vertices no*/
